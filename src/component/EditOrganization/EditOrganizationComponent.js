...
const EditOrganizationComponent = () => {
  ...
  return (
    <EditOrganizationContent newName={newName} setNewName={setNewName} nameInputOutlineColor={nameInputOutlineColor}
      newLogo={newLogo} setNewLogo={setNewLogo} logoInputOutlineColor={logoInputOutlineColor} defaultLogo={defaultLogo} setNameInputOutlineColor={setNameInputOutlineColor} setLogoInputOutlineColor={setLogoInputOutlineColor} />
  )
}
